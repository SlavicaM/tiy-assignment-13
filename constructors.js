...
//console.assert(true); => should be undefined
...
//method growl on it's prototype
Cat.prototype = {
  growl: function() {
    return "meow";
  }
}  
//create an instance of this called car
var cat = new Cat();
...
var KeepSecret = (function() {
  ...
  var mySecret;
        ...
        //create a constructor function which will except a param
...
//callback
var Safe = (function() {
//create a constructor function 'Key'
function Key () {	
}
...
var instOfKey;
     ...
     //create a constructor function 'Safe'
